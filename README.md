...
Este projeto é uma suíte de automação de testes de alto nível desenvolvida com **Cypress 13**, estruturada sob a metodologia **BDD (Behavior-Driven Development)** com **Cucumber Gherkin** e **Page Object Model (POM)** estritamente em *.
